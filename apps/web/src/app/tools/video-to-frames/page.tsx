...
export default function VideoToFramesPage() {
  return (
    <>
      <section data-theme="shell" className="pt-40 pb-20">
        <div className="container">
          <Reveal>
            <nav className="timecode mb-6" aria-label="Breadcrumb">
            ...
            <h1 className="text-display-lg mt-6 max-w-3xl">Video &rarr; Frames</h1>
